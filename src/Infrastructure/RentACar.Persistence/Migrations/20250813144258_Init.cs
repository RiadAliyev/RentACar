        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RegistrationNumber = table.Column<string>(type: "nvarchar(60)", maxLength: 60, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CarFeatureAssignments", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CarFeatureAssignments_CarFeatures_FeatureId",
                        column: x => x.FeatureId,
                        principalTable: "CarFeatures",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CarFeatureAssignments_Cars_CarId",
                        column: x => x.CarId,
                        principalTable: "Cars",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Bookings_CustomerId_StartDate",
                table: "Bookings",
                columns: new[] { "CustomerId", "StartDate" });

            migrationBuilder.CreateIndex(
                name: "IX_CarFeatureAssignments_CarId_FeatureId",
                table: "CarFeatureAssignments",
                columns: new[] { "CarId", "FeatureId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_CarFeatureAssignments_FeatureId",
                table: "CarFeatureAssignments",
                column: "FeatureId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Payments_BookingId_PaidAt",
                table: "Payments",
                columns: new[] { "BookingId", "PaidAt" });

            migrationBuilder.CreateIndex(
                name: "IX_Reviews_CarId_CustomerId",
                table: "Reviews",
